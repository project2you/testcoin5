 ...
 * #FELIXTOKEN  
 * Website :  felixtoken.com
 * 
 * #FELIXTOKEN is made to be fully transferred to its beloved community.
 * 
 * #FELIXTOKEN community is completely organic and will work hard as a community to make each member crypto-rich.
 * 
 * 30% of total supply and 5 BNB was added as initial liquidity to PancakeSwap.
 * 
 * Great & Simple Features:
 * 
 * Absolutely no fees on buy transactions / 0% Buy fee / Non-fee
 * 
 * In Every Sell Transaction
 * 
 * 1% Fee is Automatically burned
 * 3% Fee is Automatically added to Liquidity Pool.
 * 3% Fee is Automatically redistributed to holders.
 * 3% Fee is Automatically sent to Marketing Wallet. 
 * 
 * ( Marketing wallet is transparent and used only for the development and marketing of the project for the benefit and growth of the $FLX community )
 * 
 * 
 * Total Supply  |  1 Trillion
 * 30% Liquidity Pool ( Fair & Locked 🔓 )
 * 5%  Dev locked
 * 10% Marketing
 * 10% Burn
 * 17% Team
 * 8% Save Cats
 * 20% Locked for Cex listing
 * 
 * 
 
 * 
 * We are not affiliated with any other groups, projects or teams. We are the original $FLX team.
 * Please beware of all types of scams and scammers.
*/
...
contract FELIX is Context, IERC20, Ownable {
    ...
    string private _name = "Pro token";
    ...
    address public marketingWallet = 0x2FB32A905935FeE1CC486851ec6306BC03DE2Fd9;
